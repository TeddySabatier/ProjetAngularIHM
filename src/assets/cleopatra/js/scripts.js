...
var options = function(type, height, numbers , color){
  ...
  if (analytics_1 != null && typeof(analytics_1) != 'undefined') {
      var chart = new ApexCharts(analytics_1[0], options("area" , '100px' , numArr(10,99) , '#120078')); 
      var chart_1 = new ApexCharts(analytics_1[1], options("area" , '100px' , numArr(10,99) , '#4c51bf')); 
      chart.render();       
      chart_1.render();       
  }
